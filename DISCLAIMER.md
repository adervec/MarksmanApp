...
**Short version:** Marksman is a hobby project written by a software developer.
I am **not** a coach, instructor, doctor, or lawyer. This software and its
accompanying documents are provided for general informational and personal
progress‑tracking purposes only. They are **not** professional coaching,
training, medical, safety, or legal advice, and **not** an official scoring
system. **Use everything here entirely at your own risk.**

This document supplements — and does not limit — the warranty and liability
terms in the [LICENSE](LICENSE) (MIT).
...
purpose, accuracy, and non‑infringement. The author is not liable for any
claim, damages, loss, or injury arising from its use. See the [LICENSE](LICENSE)
for the controlling legal text.
...
- Obey your field's **FPS / joule limits and minimum engagement distances**.
- Treat every replica as capable of firing; keep it on safe with your finger
  off the trigger until you intend to shoot; use a barrel/blast cover in safe
  zones.
...
project are referenced for information only. Details may be incomplete,
...
direct, indirect, incidental, consequential, or other damages, or for any
injury or loss, arising out of or in connection with the use of this software or
its documentation, even if advised of the possibility of such damages.

---

*By using this software or its documents, you acknowledge that you have read and
agree to this disclaimer. This page is general information, not legal advice.*
